...
public class MovementControllerRight : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.Q)){
            ...
            // transform.rotation = Quaternion.LookRotation(direction);//FromToRotation(laser.transform.forward, transform.forward);
